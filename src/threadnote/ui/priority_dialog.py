...
class PriorityDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        priority_info = {
            1: (
                self._("P1: Urgent + Important"),
                self._("Do First - Critical tasks requiring immediate attention"),
            ),
            2: (
                self._("P2: Not Urgent + Important"),
                self._("Schedule - Important goals and planning"),
            ),
            3: (
                self._("P3: Urgent + Not Important"),
                self._("Delegate - Interruptions and distractions"),
            ),
            4: (
                self._("P4: Not Urgent + Not Important"),
                self._("Eliminate - Time wasters"),
            ),
        }
