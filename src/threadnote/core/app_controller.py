...
class AppController:
    ...
    def __init__(self, translator: Callable[[str], str], preferences: UserPreferences) -> None:
        self._window = MainWindow(translator)
        self._config = load_config()
        self._prefs = preferences
        self._archive_manager = ArchiveManager(self._config.project_root / "data", translator)
    ...
    def _on_language_change_requested(self):
        ...
        dialog = LanguageDialog(current_locale=current_locale, translator=self._window._, parent=self._window)
